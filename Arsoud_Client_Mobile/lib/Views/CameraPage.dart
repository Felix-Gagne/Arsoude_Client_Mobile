...
class CameraPage extends StatefulWidget {
  const CameraPage({super.key, required this.cameras, required this.randonne});
...
class _CameraPageState extends State<CameraPage> {
  ...
  Future takePicture() async {
    ...
    try {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => PreviewPage(picture: picture, randonne: widget.randonne,)));
                      ...
                      children: [
                        ...
                        Expanded(
                            child: IconButton(
                              ...
                              onPressed: () {
                                setState(() => _isRearCameraSelected = !_isRearCameraSelected);initCamera(widget.cameras![_isRearCameraSelected ? 0 : 1]);
                              },
                            )),
                      ]),
                )),
