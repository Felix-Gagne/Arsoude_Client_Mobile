...
@immutable
class ArsoudePosition {
  /// Constructs an instance with the given values for testing. [ArsoudePosition]
  /// instances constructed this way won't actually reflect any real information
  /// from the platform, just whatever was passed in at construction time.
  const ArsoudePosition({
  ...
  bool operator ==(Object other) {
    var areEqual = other is ArsoudePosition &&
  ...
  /// Converts the supplied [Map] to an instance of the [ArsoudePosition] class.
  static ArsoudePosition fromMap(dynamic message) {
  ...
  /// Converts the [ArsoudePosition] instance into a [Map] instance that can be
  /// serialized to JSON.
